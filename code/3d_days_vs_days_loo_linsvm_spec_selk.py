...
def linsvm_predict_for_one(train_comps, test_comp, train_exdict, test_exdict, fold_keep_inds, params, pos_lab, neg_lab):
    ...
    clf = GridSearchCV(est, param_grid=params, iid=False) # optimizes accuracy for SVC
...
for test_comp in uniq_comps:
    ...
    day_preds = linsvm_predict_for_one(train_comps, test_comp, train_exdict, test_exdict, fold_keep_inds, PARAMS, POS_LAB, NEG_LAB)
