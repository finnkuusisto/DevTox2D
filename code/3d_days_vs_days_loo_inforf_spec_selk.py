...
def inforf_predict_for_one(train_comps, test_comp, train_exdict, test_exdict, fold_keep_inds, pos_lab, neg_lab):
...
for test_comp in uniq_comps:
    ...
    day_preds = inforf_predict_for_one(train_comps, test_comp, train_exdict, test_exdict, fold_keep_inds, POS_LAB, NEG_LAB)
