...
def multinb_predict_for_one(train_comps, test_comp, train_exdict, test_exdict, pos_lab, neg_lab):
...
for test_comp in uniq_comps:
    ...
    day_preds = multinb_predict_for_one(train_comps, test_comp, train_exdict, test_exdict, POS_LAB, NEG_LAB)
