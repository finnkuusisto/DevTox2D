...
def linsvm_predict_for_one(train_comps, test_comp, train_exdict, test_exdict, params, pos_lab, neg_lab):
...
for test_comp in uniq_comps:
    ...
    day_preds = linsvm_predict_for_one(train_comps, test_comp, train_exdict, test_exdict, PARAMS, POS_LAB, NEG_LAB)
